...
const ContactUs = () => {
  return (
    <>
    <Flex className='social_link_buttons_mobile flex md:hidden w-full gap-3 p-5'>
     ...
     <div className='contactUs p-5 rounded-md hidden md:block md:w-1/2' style={{ background: `url('icons/Group.svg') right no-repeat, black` }}>
